...
def main(args):
    ...
    #model = SingleStageEmbeddingNetWithBNNeck(encoder_name=cfg['encoder_name']).to(device)
    model = SingleStageEmbeddingNetWithBNNeckV2(encoder_name=cfg['encoder_name']).to(device)
