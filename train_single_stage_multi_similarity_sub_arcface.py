...
def main(args):
    ...
    model = SingleStageEmbeddingNetWithBNNeck(encoder_name=cfg['encoder_name'],
    ...
    loss_cls = losses.SubCenterArcFaceLoss(num_classes = num_classes, embedding_size = cfg['embedding_size']).to(device)
    ...
    optimizer = optim.AdamW([
        ...
        {'params': loss_cls.parameters(), 'lr': float(cfg['lr']) * 10},
